...
if len(sys.argv) > 2:
    ...
    print izh_mem[0] == nest_mem[0]
    print izh_mem[-1] == nest_mem[-1]
    ...
    if len(ids_mismatch > 0):
        print "first mismatch at time {t} at neuron {n}".format(t=izh_mem[ids_mismatch[0]][1],
                                                                n=izh_mem[ids_mismatch[0]][0])
