...
phf.plot_raster_rate(statistical_times,statistical_senders,ax01,ax02)
...
phf.plot_psd(statistical_times, statistical_senders,ax2,incolor=incolor,excolor=excolor)
